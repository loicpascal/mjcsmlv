	...
	<div class="entry-content page_mjc_accueil">
		<div class="actus">
			<a href="<?php echo get_permalink(10); ?>">
				<div><?php echo $actu ? 'Actus' : 'Voir toutes les actualités' ?></div>
			</a>
            <?php if ($actu) { ?>
		...
		<div class="bloc_accueil">
			...
			<button id="telechargement_plaquette" onclick="window.location='http://www.mjc-saintmarcellesvalence.fr/wp-content/uploads/2017/08/programme-mjc-saint-marcel-2017-2018.pdf';">Télécharger la plaquette des activités</button>
	</div>
